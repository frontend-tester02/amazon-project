...
const productWebPage = document.querySelector('.js-products-grid');
productWebPage.innerHTML = productsHTML;
...
const productBtns = document.querySelectorAll('.js-add-to-cart');
