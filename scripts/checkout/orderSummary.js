...
export function renderOrderSummary() {
  ...
  const checkoutHtml = document.querySelector('.js-order-summary');

  checkoutHtml.innerHTML = cartSummaryHTML;
  ...
  function updateCartQuantity() {
    ...
    const cartProductCount = document.querySelector('.js-return-to-home-link');
    cartProductCount.innerHTML = `${cartQuantity} items`
  }
  ...
  const itemDeliveryOption = document.querySelectorAll('.js-delivery-option');

  itemDeliveryOption.forEach((element) => {
